...
instruction parsing_instr(const char *buffer, const int index)
{
    ...
    char *instruction = (char *)buffer;
    instr.value = fromBinary(instruction);
    mem_write_32(MEM_TEXT_START + index, instr.value);
    
    SET_OPCODE(&instr, (instr.value >> 26));
    SET_FUNC(&instr, ((instr.value << 26) >> 26));
    ...
    switch(instr.opcode)
        {
            ...
            case 0x5:		//(0x000101)BNE
                SET_RS(&instr,((instr.value & 0b00000011111000000000000000000000) >> 21));
	            SET_RT(&instr,((instr.value & 0b00000000000111110000000000000000) >> 16));
	    	    SET_IMM(&instr,(instr.value & 0b00000000000000001111111111111111));
                break;
            ...
            case 0x0:		//(0x000000)ADDU, AND, NOR, OR, SLTU, SLL, SRL, SUBU  if JR
                SET_RS(&instr,((instr.value & 0b00000011111000000000000000000000) >> 21));
	            SET_RT(&instr,((instr.value & 0b00000000000111110000000000000000) >> 16));
                SET_RD(&instr,((instr.value & 0b00000000000000001111100000000000) >> 11));
	        	SET_SHAMT(&instr,((instr.value & 0b00000000000000000000011111000000) >> 6));
            ...
            case 0x3:		//(0x000011)JAL
                SET_TARGET(&instr,(instr.value & 0b00000011111111111111111111111111));
                break;
        }
    return instr;
}
...
{
    unsigned int Data = fromBinary(buffer);
